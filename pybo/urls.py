...
#   path('comment/create/quedstion/<int:question_id>/', views.comment_create_question,
#     name='comment_create_question'),
#   path('comment/modify/quedstion/<int:comment_id>/', views.comment_modify_question,
#     name='comment_modify_question'),
#   path('comment/delete/quedstion/<int:comment_id>/', views.comment_delete_question,
